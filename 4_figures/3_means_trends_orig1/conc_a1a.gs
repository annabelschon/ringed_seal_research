...
*   below.
   ...
   'open ../../1_topo_vege/5_mk_final_topo_vege/seals_topo_vege_500m.ctl'
    var_name = 'conc_a1a'
*   a_lab = 'mean sea ice conc (%)'
*   b_lab = 'conc trend (% decade`a-1`n)'
    a_lab = ' '
    b_lab = ' '
    c_lab1 = 'concentration'
    c_lab2 = '(%)'
    d_lab1 = 'concentration'
    d_lab2 = '(%)'
...
*   panel_b_clevs = '-0.08 -0.06 -0.04 -0.02 0 0.02 0.04 0.06 0.08'
    panel_b_clevs = '-12.0 -9.0 -6.0 -3.0 0 3.0 6.0 9.0 12.0'
    panel_c_vrange = '5 45'
    panel_c_ylint = '5'
    panel_d_vrange = '20 70'
    panel_d_ylint = '10'
