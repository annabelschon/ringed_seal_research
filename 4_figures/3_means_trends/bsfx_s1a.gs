...
*   b_lab = 'bs flux trend (m`a3`n m`a-1`n decade`a-1`n)'
    a_lab = ' '
    b_lab = ' '
*   c_lab1 = 'blowing snow flux'
    c_lab1 = 'snow flux'
    c_lab2 = '(kg m`a-1`n s`a-1`n)'
*   d_lab1 = 'seal lair density'
*   d_lab1 = 'lair density'
    d_lab1 = 'seal lair'
*   d_lab2 = '(lairs ha`a-1`n)'
*   d_lab2 = '(lairs hm`a-2`n)'
    d_lab2 = 'habitat index'
...
*   panel_b_clevs = '-200.0 -150.0 -100.0 -50.0 0 50.0 100.0 150.0 200.0'
    ...
    panel_c_vrange = '0 2.5'
    panel_c_ylint = '0.5'
    panel_d_vrange = '0 500'
    panel_d_ylint = '100'
...
*'set clevs 30 40 50 60 70 80 90 100 150 200 250 300'
 'set clevs 0.25 0.5 0.75 1 1.25 1.5 2 3'
 'd 'var_name'.1'
...
*   'draw string 'labx4-0.13' 'laby4' 'd_lab2
