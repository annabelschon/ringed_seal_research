...
*   below.
   ...
   'open ../../1_topo_vege/5_mk_final_topo_vege/seals_topo_vege_500m.ctl'
    var_name = '100*snod_1ap'
*   a_lab = '1 April Snow Depth (cm)'
*   b_lab = 'depth trend (cm decade`a-1`n)'
    a_lab = ' '
    b_lab = ' '
    c_lab1 = 'snow depth'
    c_lab2 = '(cm)'
...
*   panel_b_clevs = '-20.0 -15.0 -10.0 -5.0 0 5.0 10.0 15.0 20.0'
*   panel_b_clevs = '-12.0 -9.0 -6.0 -3.0 0 3.0 6.0 9.0 12.0'
    panel_b_clevs = '-16.0 -12.0 -8.0 -4.0 0 4.0 8.0 12.0 16.0'
    panel_c_vrange = '0 60'
    panel_c_ylint = '10'
    panel_d_vrange = '0 60'
    panel_d_ylint = '10'
