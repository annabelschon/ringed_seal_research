...
c Check to see if your array space is large enough for this
c   domain.
      if (nx+1.gt.nx_max .or. ny+1.gt.ny_max) then
        print *, 'You must increase the value of nx_max or ny_max'
        print *, '  in:'
        print *, '  /sm/topo_vege/process_data/xx/3_merge_topo_vege/'
        print *, '    1_merge_topo_vege.f'
        print *, '  to be greater than nx+1 and/or ny+1.'
