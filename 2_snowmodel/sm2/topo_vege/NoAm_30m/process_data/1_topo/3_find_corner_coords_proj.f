...
c Now read in the southern center coords, and use that as the
c   minimum, if it is the smallest.
      open (22,file='outputs/2_southern_center_proj.dat')
      read (22,*) x_dum,y_southcentral

      y_min = min(y_min,y_southcentral)
