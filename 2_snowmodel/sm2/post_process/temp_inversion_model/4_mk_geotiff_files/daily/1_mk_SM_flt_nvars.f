...
c This card should not be changed.
      ...
      data varnames /'tamc','invi'/
c     data varnames /'tamc','tmch'/
c     data varnames /'tsfc','tasc','invi'/
c     data varnames /'tair','snod','sden','wspd'/
...
c   additional code modifications.
      ...
      parameter (run_name='OldCrow_100m')
c     parameter (run_name='COAT_SM_030m')

c Point to where the SnowModel output data are located.
      parameter (path_in=
     &  '/data4/moose/oldcrow/process/')

c Point to where the SnowModel .flt and .hdr files should be
c   put.
      parameter (path_out=
     &  '/data4/moose/oldcrow/process/flt_files/')
