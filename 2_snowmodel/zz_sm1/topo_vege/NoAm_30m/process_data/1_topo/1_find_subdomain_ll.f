...
c   SnowModel simulation domain.
      open (21,file='../../1_SM_dxdy_cornerll_proj_INPUTS.dat')
...
c This will be used to keep the southern domain as far south as
c   originally intended by the lat-lon bounds.
      open (71,file='outputs/1_subdomain_ll_southern_center.dat')
      write (71,95) (xll_lon+xur_lon)/2.0,yll_lat
