...
c Save the data as .flt files.
      call flt_outputs(nx,ny,path_out,topo,ctopo,xmn,ymn,
     &  deltaxy,undef,run_name)

      call flt_outputs(nx,ny,path_out,vege,cvege,xmn,ymn,
     &  deltaxy,undef,run_name)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      subroutine flt_outputs(nx,ny,path_out,var,cvar,xmn,ymn,
     &  deltaxy,undef,run_name)

      implicit none

      integer i,j,nx,ny,jj
      real var(nx,ny)
      double precision xmn,ymn
      real deltaxy,undef
