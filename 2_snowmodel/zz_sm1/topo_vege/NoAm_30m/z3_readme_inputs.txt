...
Typically AEA domains (e.g., Alaska, CONUS, No Am, and
Canada) have predefined values for the two extra parallels
that are commonly used, like the Alaska AEA projection.
But if you are making up your own, a common practice for
this projection is to place standard parallels at one-sixth
of the latitude range below the top and above the bottom of
the area to be mapped.  For the LAEA projection, I usually
just set the lat and lon of the projection equal to the
center of my simulation domain.

This is an example LAEA projection:

+proj=laea +lat_0=71.2 +lon_0=-179.3 +x_0=0 +y_0=0
  +datum=WGS84 +units=m +no_defs

This is an example AEA projection (the standard Alaska AEA):

+proj=aea +lat_1=55.0 +lat_2=65.0 +lat_0=50.0
  +lon_0=-154.0 +x_0=0.0 +y_0=0.0 +datum=NAD83 +units=m
  +no_defs

This is an example UTM projection:

+proj=utm +zone=19 +ellps=WGS84 +datum=WGS84 +units=m
  +no_defs
