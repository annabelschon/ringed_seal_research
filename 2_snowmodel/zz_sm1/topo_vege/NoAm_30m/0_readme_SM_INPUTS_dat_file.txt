============================================================
 This file describes what the first 8 lines of this file:
 
   1_SM_dxdy_cornerll_proj_INPUTS.dat
 
 must look like.  Examples are provided in the discussion
 below.
============================================================
...
coords of the simulation domain will be the exact coordinates
...
(100s of km), and AEA for continental domains (1000s of km; e.g.,
Alaska, CONUS, No Am).
...
+proj=laea +lat_0=53.0 +lon_0=-86.0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs



or

+proj=aea +lat_1=63.0 +lat_2=71.0 +lat_0=67.0 +lon_0=-142.0 +x_0=0.0 +y_0=0.0 +datum=NAD83 +units=m +no_defs
