...
c Define the name of the MicroMet output file.
      open (31,file=
     &  '/data3/annabel/seals/2_merra2/mm_3hrly_1980-2023.dat')
c    &   status='old', position='append')
c     open (31,file=
c    &  '/data3/annabel/seals/2_merra2/mm_daily_1980-1981.dat')
