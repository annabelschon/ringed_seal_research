...
c   steps.
      ...
      open (62,file='outputs/5_sm_center_lat_final.dat')
      ave_bot = (yll_lat + ylr_lat) / 2.0
      ave_top = (yul_lat + yur_lat) / 2.0
      xlat_center = (ave_bot + ave_top) / 2.0
      write (62,96) xlat_center

c Add xlat_center to the "SM_OUTPUTS" file.
      open (63,file='../../SM_domain_config_info_OUTPUTS.dat',
     &  position='append')
      write (63,101) xlat_center

  101 format ('xlat   = ',f8.2)
