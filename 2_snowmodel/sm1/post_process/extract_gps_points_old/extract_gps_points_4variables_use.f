...
c   just are not as efficient as this version of the code.
      ...
      integer julian,k,i,j,idy,imo,iyr,itime_rec,irec,nrecs,
     &  iyr_start,imo_start,idy_start,iyr_end,imo_end,ii,jj,
     &  idy_end,ioptn,julian_end,julian_start,irec_option,id
...
c Read in the data and coordinate information.
        read (31,*) id,iyr,imo,idy,x,y
        ...
        itime_rec = julian - julian_start + 1
...
c Find the data-block record.
        irec = (itime_rec - 1) * nx * ny + (jj - 1) * nx + ii
c       print *, irec
...
c Save the data.
        write (61,92) k,iyr,imo,idy,ii,jj,tair,snod,sden,wspd
c       write (61,91) k,iyr,imo,idy,ii,jj,tair,snod,sden,wspd
