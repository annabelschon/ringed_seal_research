...
*    'define mod=100.0*snod_mod.1'
     ...
     'define obs=sden_obs.1'
     'define mod=sden_mod.1'
...
*************************************
  ...
  'set strsiz 0.22'
   x1 = xmn-0.7
   y1 = (ymn+ymx)/2
  'draw string 'x1' 'y1' SnowModel Snow Density (kg m`a-3`n)'

  'set string 1 c 4 0'
  'set strsiz 0.22'
   x1 = (xmn+xmx)/2
   y1 = ymn-0.5
  'draw string 'x1' 'y1' Observed Snow Density (kg m`a-3`n)'
