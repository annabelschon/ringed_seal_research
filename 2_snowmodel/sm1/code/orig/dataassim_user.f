...
c   /sm/swe_assim/.  And it is assumed to be called: swe_obs.dat.
...
c   file written to /sm/swe_assim/ that provides a summary of
...
c   generated.  This is also placed in /sm/swe_assim/, the file
