c calndr_1hrly.f
      ...
      integer ihrs_in_day,iyr_start,imo_start,idy_start,iyr_end,
     &  imo_end,idy_end,ioptn,julian_end,julian_start,julian,k,
     &  kk,iday,imonth,iyear,ihr_start,ihr_end,last
