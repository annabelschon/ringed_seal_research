...
*   below.
   ...
   'open ../../../topo_vege/NoAm_30m/topo_vege.ctl'
    var_name = 'spre_sum'
    a_lab = 'total snowfall (cm)'
    b_lab = 'snowfall trend (cm decade`a-1`n)'
    c_lab1 = 'snowfall'
    c_lab2 = '(cm)'
...
*   panel_b_clevs = '-40 -30 -20 -10 0 10 20 30 40'
    panel_b_clevs = '-12 -9 -6 -3 0 3 6 9 12'
    panel_c_vrange = '12 36'
    panel_c_ylint = '4'
...
* PANEL c.
 ...
 'd 100*'var_name'.3(x=1)'
 'set cmark 0'
 'set ccolor 1'
 'd 100*'var_name'.3(x=2)'
